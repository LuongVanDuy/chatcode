(() => {
  ...
  const CLEANUP_CSS = `
    ...
    #route-connection .connection-banner{padding:12px 0 18px!important;border:0!important;border-bottom:1px solid var(--ui-border-soft)!important;border-radius:0!important;background:transparent!important}
    #route-connection>.page>.two-col{gap:24px;border:0;border-radius:0;overflow:visible;background:transparent}
    #route-connection>.page>.two-col>.card{border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important;background:var(--ui-surface)!important}
    #route-connection>.page>.two-col>.card:first-child{border-right:1px solid var(--ui-border)!important}
    #route-connection>.page>article.card:not(.connection-banner){padding:16px 0!important;border:0!important;border-top:1px solid var(--ui-border-soft)!important;border-radius:0!important;background:transparent!important}
    ...
    .settings-safety-launch{display:flex;align-items:center;gap:16px;padding:16px 2px;border-top:1px solid var(--ui-border-soft);border-bottom:1px solid var(--ui-border-soft)}
    .settings-safety-launch>div{flex:1;min-width:0;display:flex;flex-direction:column;gap:3px}.settings-safety-launch strong{font-size:14px;font-weight:600}.settings-safety-launch span{color:var(--ui-muted);font-size:13px;line-height:1.5}
    ...
    .settings-safety-panel>.page-head{align-items:center;padding-top:4px}.settings-safety-panel>.page-head .eyebrow{display:none}.settings-safety-panel>.page-head h2{font-size:20px;line-height:28px}.settings-safety-panel>.page-head p{font-size:13px;line-height:1.5}
    .settings-safety-panel .safety-summary-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:0;border:1px solid var(--ui-border);border-radius:var(--ui-radius-md);overflow:hidden;background:var(--ui-surface)}
    .settings-safety-panel .safety-summary{min-width:0;padding:14px 16px!important;border:0!important;border-right:1px solid var(--ui-border-soft)!important;border-radius:0!important;background:var(--ui-surface)!important;color:var(--ui-text)!important;box-shadow:none!important}
    .settings-safety-panel .safety-summary:last-child{border-right:0!important}.settings-safety-panel .safety-summary span,.settings-safety-panel .safety-summary small{color:var(--ui-muted)!important;font-size:12px!important}.settings-safety-panel .safety-summary strong{color:var(--ui-text)!important;font-size:15px!important}
    ...
    #project-tab-permissions{display:flex;flex-direction:column;gap:16px}
    #project-tab-permissions>.two-col{display:grid;grid-template-columns:minmax(260px,.88fr) minmax(360px,1.12fr);gap:0;margin:0;border:1px solid var(--ui-border);border-radius:var(--ui-radius-md);overflow:hidden;background:var(--ui-surface)}
    #project-tab-permissions>.two-col>.card{margin:0!important;padding:16px!important;border:0!important;border-radius:0!important;background:transparent!important;box-shadow:none!important}
    #project-tab-permissions>.two-col>.card:first-child{border-right:1px solid var(--ui-border-soft)!important}
    #project-tab-permissions .preset-grid{display:flex;flex-direction:column;gap:8px}
    #project-tab-permissions .preset-grid button{min-height:52px;padding:12px!important;border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important;background:var(--ui-surface-2)!important;color:var(--ui-text-2)!important;text-align:left;font-size:14px;box-shadow:none!important}
    ...
    #project-tab-permissions .perm{min-height:56px;padding:12px 2px!important;border-bottom:1px solid var(--ui-border-soft)!important;background:transparent!important;color:var(--ui-text)!important}
    #project-tab-permissions .perm:last-of-type{border-bottom:0!important}
    #project-tab-permissions .perm strong{color:var(--ui-text)!important;font-size:14px!important}.project-tab#project-tab-permissions .perm span{color:var(--ui-muted)!important;font-size:13px!important;line-height:1.45}
    #project-tab-permissions input[type="checkbox"]{accent-color:var(--ui-accent);color-scheme:dark}
    #project-tab-permissions input[type="checkbox"]:disabled{opacity:.5}

    #v10WorkspaceMode{margin:0!important;padding:0 0 16px!important;border:0!important;border-bottom:1px solid var(--ui-border-soft)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important}
    #v10WorkspaceMode .card-head{margin-bottom:12px}.v10-mode-badge{padding:5px 8px!important;border:1px solid var(--ui-border)!important;background:var(--ui-surface-2)!important;color:var(--ui-muted)!important;font-size:12px!important}.v10-mode-badge.trusted{background:rgba(130,214,164,.10)!important;border-color:rgba(130,214,164,.32)!important;color:var(--ui-success)!important}
    .v10-mode-grid{gap:8px!important;margin:0!important}.v10-mode-option{min-height:76px!important;padding:14px!important;border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important;background:var(--ui-surface-2)!important;color:var(--ui-text)!important;box-shadow:none!important}.v10-mode-option:hover{background:var(--ui-hover)!important;border-color:var(--ui-border)!important}.v10-mode-option.active{border-color:var(--ui-accent)!important;background:var(--ui-active)!important;box-shadow:none!important}.v10-mode-option.trusted.active{border-color:var(--ui-accent)!important;background:var(--ui-accent-bg)!important;box-shadow:none!important}.v10-mode-option strong{color:var(--ui-text)!important;font-size:14px!important;margin-bottom:3px!important}.v10-mode-option span{color:var(--ui-muted)!important;font-size:13px!important;line-height:1.45}.v10-mode-option svg{width:18px!important;height:18px!important;color:var(--ui-text-2)}
    .v10-trusted-options{gap:10px!important;margin-top:12px!important}.v10-secret-toggle{padding:12px!important;border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important;background:var(--ui-surface-2)!important;color:var(--ui-text)!important}.v10-secret-toggle strong{color:var(--ui-text)!important;font-size:13px!important}.v10-secret-toggle span{color:var(--ui-muted)!important;font-size:12px!important}.v10-boundaries{gap:6px!important}.v10-boundaries span{padding:5px 8px!important;border:1px solid var(--ui-border)!important;border-radius:999px!important;background:transparent!important;color:var(--ui-muted)!important;font-size:12px!important}.v10-mode-note{margin-top:12px!important;padding:10px 0 0!important;border:0!important;border-top:1px solid var(--ui-border-soft)!important;border-radius:0!important;background:transparent!important;color:var(--ui-muted)!important;font-size:13px!important;line-height:1.5}

    #v07SafetyRules{margin:0!important;padding:16px 0 0!important;border:0!important;border-top:1px solid var(--ui-border-soft)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important}
    #v07SafetyRules .card-head{margin-bottom:12px}.safety-rules-card .safety-rule-grid{display:grid!important;grid-template-columns:repeat(3,minmax(0,1fr))!important;gap:0!important;border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important;overflow:hidden;background:var(--ui-surface)!important}.safety-rules-card .safety-rule-grid label{min-width:0;padding:12px!important;border:0!important;border-right:1px solid var(--ui-border-soft)!important;border-bottom:1px solid var(--ui-border-soft)!important;border-radius:0!important;background:transparent!important;color:var(--ui-text)!important;box-shadow:none!important}.safety-rules-card .safety-rule-grid label:nth-child(3n){border-right:0!important}.safety-rules-card .safety-rule-grid label:nth-last-child(-n+3){border-bottom:0!important}.safety-rules-card .safety-rule-grid span{color:var(--ui-text-2)!important;font-size:13px!important;font-weight:500!important}.safety-rules-card .safety-rule-grid select{margin-top:8px!important;min-height:36px!important;padding:7px 10px!important;background:var(--ui-surface-2)!important;color:var(--ui-text)!important;border-color:var(--ui-border)!important;font-size:14px!important}

    .ui-permission-advanced{margin:0;border:1px solid var(--ui-border);border-radius:var(--ui-radius-md);background:var(--ui-surface);overflow:hidden}.ui-permission-advanced>summary{list-style:none;min-height:44px;padding:11px 14px;display:flex;align-items:center;gap:9px;color:var(--ui-text-2);font-size:14px;font-weight:500;cursor:pointer;user-select:none}.ui-permission-advanced>summary::-webkit-details-marker{display:none}.ui-permission-advanced>summary:before{content:'›';width:16px;color:var(--ui-muted);font-size:18px;line-height:1;transition:transform .14s ease}.ui-permission-advanced[open]>summary:before{transform:rotate(90deg)}.ui-permission-advanced>summary:hover{background:var(--ui-hover);color:var(--ui-text)}.ui-permission-advanced-body{padding:0 14px 14px}.ui-permission-advanced-body>.card{margin:0!important;padding:16px 0!important;border:0!important;border-top:1px solid var(--ui-border-soft)!important;border-radius:0!important;background:transparent!important;box-shadow:none!important}.ui-permission-advanced-body>.card:first-child{border-top:1px solid var(--ui-border-soft)!important}.ui-permission-advanced .v10-terminal-form input{background:var(--ui-surface-2)!important}.ui-permission-advanced .v10-job{border-color:var(--ui-border)!important;background:var(--ui-surface-2)!important}.ui-permission-advanced .v10-job-main code,.ui-permission-advanced .v10-job-meta{color:var(--ui-text-2)!important;font-size:13px!important}

    /* Real switches: compact, readable and consistent with the shared accent. */
    #route-settings .setting input[type="checkbox"]{position:relative!important;appearance:none!important;-webkit-appearance:none!important;width:40px!important;height:22px!important;min-height:22px!important;flex:0 0 40px!important;padding:0!important;margin:0!important;border:1px solid var(--ui-border)!important;border-radius:999px!important;background:var(--ui-surface-3)!important;background-image:none!important;box-shadow:none!important;cursor:pointer;transition:background .14s ease,border-color .14s ease}
    #route-settings .setting input[type="checkbox"]::after{content:'';position:absolute;left:2px;top:2px;width:16px;height:16px;border-radius:50%;background:var(--ui-muted);transition:transform .14s ease,background .14s ease}
    #route-settings .setting input[type="checkbox"]:checked{background:var(--ui-accent)!important;border-color:var(--ui-accent)!important;background-image:none!important}
    #route-settings .setting input[type="checkbox"]:checked::after{transform:translateX(18px);background:var(--ui-sidebar)}
    #route-settings .setting input[type="checkbox"]:focus-visible{outline:2px solid var(--ui-accent);outline-offset:2px}
    #route-settings .setting input[type="checkbox"]:hover{border-color:var(--ui-muted)!important}.setting input[type="checkbox"]:disabled{opacity:.5!important;cursor:not-allowed!important}

    /* Neutral log language shared by Activity, Terminal, Work Session, Git/Task and Support. */
    .activity-list,.support-events{background:#17191E!important;border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important;color:var(--ui-text-2)!important;box-shadow:none!important;overflow:auto}.activity-log-head{background:var(--ui-surface-2)!important;color:var(--ui-muted)!important;border-bottom:1px solid var(--ui-border)!important}.activity-log-line{background:transparent!important;border-bottom:1px solid var(--ui-border-soft)!important;color:var(--ui-text-2)!important}.activity-log-line:hover{background:var(--ui-hover)!important}.activity-log-time,.activity-log-duration{color:var(--ui-muted)!important}.activity-log-tool{color:var(--ui-accent-strong)!important;font-weight:600!important}.activity-log-project{color:var(--ui-text-2)!important}.activity-log-target{color:var(--ui-text)!important}.activity-log-line.ok .activity-log-status{color:var(--ui-success)!important}.activity-log-line.failed .activity-log-status{color:var(--ui-danger)!important}.activity-log-error{color:var(--ui-danger)!important;background:rgba(255,156,156,.08)!important;border-left:2px solid var(--ui-danger)!important}
    #route-activity .activity-list{border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important}
    .code,.v10-job-output,.v103-detail{background:#17191E!important;color:var(--ui-text-2)!important;border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important;box-shadow:none!important;font-size:13px!important;line-height:20px!important}.v10-job-output{padding:12px!important}.v103-detail{padding:12px!important}.support-note{background:var(--ui-surface-2)!important;color:var(--ui-text)!important;border:1px solid var(--ui-border)!important;border-radius:var(--ui-radius-md)!important;box-shadow:none!important}.support-note:focus{background:var(--ui-surface-2)!important;border-color:var(--ui-accent)!important;box-shadow:0 0 0 2px rgba(169,184,255,.12)!important}.support-events{background:#17191E!important}.support-event{border-bottom:1px solid var(--ui-border-soft)!important}.support-event:hover{background:var(--ui-hover)!important}.support-event>span,.support-event small{color:var(--ui-muted)!important}.support-event code{color:var(--ui-text-2)!important}.support-event.marker{background:rgba(169,184,255,.08)!important;box-shadow:inset 2px 0 0 var(--ui-accent)!important}.support-event.risk{box-shadow:inset 2px 0 0 var(--ui-warning)!important}
  ...
  function moveSafetyIntoSettings() {
    ...
    launch.innerHTML = '<div><strong>Kiểm soát AI & Safety</strong><span>Phê duyệt thao tác nhạy cảm, recovery snapshot và backup cấu hình.</span></div><button id="toggleSafetySettings" class="btn" aria-expanded="false" aria-controls="settingsSafetyPanel"><i data-lucide="shield-check" aria-hidden="true"></i><span>Mở</span></button>';
  ...
  async function boot() {
    ...
    window.__chatcodeRenderer = Object.freeze({
      ...
      stage: 3,
      revision: 'desktop-readability-polish',
